...
// único control es el toggle ES/EN — sin esto no habría ninguna forma de
// cambiar de idioma aquí, ya que el resto del chrome del sitio (donde vive
// el toggle normal) está oculto.
