  ...
  return {
    rules: [
      ...
      // empiece igual (/cotizar/..., /gracias/...), no solo el path exacto.
      {
        userAgent: '*',
        allow: '/',
        disallow: ['/api/', '/studio/', '/cotizar', '/gracias', '/agenda/gracias', '/reserva/gracias', '/departamentos-en-cancun-valmira/gracias', '/portafolio-cancun/gracias', '/departamentos-en-cancun-loreta/gracias'],
      },
    ],
