...
export default function PortafolioGracias() {
  ...
  //
  // OJO: el `send_to` es el MISMO label que usan las landings de Valmira y
  // Vellmari. Para reportar esta campaña por separado hay que crear una
  // conversión nueva en Google Ads y cambiar el label aquí — no se puede
  ...
  useEffect(() => {
    ...
    if (typeof (window as any).fbq === 'function') {
      (window as any).fbq('track', 'Lead', { content_name: 'Portafolio Cancún', content_category: 'ads' });
    }
  }, []);
  ...
  return (
    <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden bg-ink px-6 py-16 text-white">
      <Image
        src="/desarrollos/villalta/portada2.jpg"
      ...
      <div className="relative z-10 w-full max-w-lg text-center">
        ...
        <p className="mx-auto mt-4 max-w-md text-[15px] font-light leading-relaxed text-white/70">
          Un asesor te contactará muy pronto con disponibilidad real, precios y planes de pago de los
          desarrollos que te interesan. Mientras tanto, adelántate por WhatsApp:
        </p>

        <a
          href={waLink('Hola, acabo de dejar mis datos en el portafolio de desarrollos en Cancún.')}
        ...
        <div className="mx-auto mt-12 grid max-w-md gap-3 text-left sm:grid-cols-2">
          {[
            ...
            { icon: CalendarCheck, title: 'Visita o videollamada', sub: 'Presencial o desde donde estés' },
