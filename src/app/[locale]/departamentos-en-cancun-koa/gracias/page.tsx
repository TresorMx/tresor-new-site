...
export default function KoaGracias() {
  ...
  //
  // OJO: el `send_to` es el MISMO label que usan las demás landings. Para
  // reportar esta campaña por separado hay que crear una conversión nueva
    ...
    <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden bg-ink px-6 py-16 text-white">
      ...
      <div className="relative z-10 w-full max-w-lg text-center">
        ...
        <p className="mx-auto mt-4 max-w-md text-[15px] font-light leading-relaxed text-white/70">
          Un asesor de Koa te contactará muy pronto con precios, planes de pago y disponibilidad real. Mientras tanto, adelántate por WhatsApp:
        </p>

        <a
          href={waLink('Hola, acabo de dejar mis datos en la página de Koa. Quiero agendar una visita.')}
