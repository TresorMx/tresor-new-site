...
export default function QuattroPlazaCenterGracias() {
  // Punto único de conversión para Google Ads — se dispara al cargar esta
  // página, a la que solo se llega tras enviar el formulario.
  //
  // OJO: el `send_to` es el MISMO label que usan las demás landings
  // (Valmira, Vellmari, Portafolio, Loreta, Lausana). Para reportar esta
  // campaña por separado hay que crear una conversión nueva en Google Ads y
  // cambiar el label aquí — no se puede hacer desde el código.
  useEffect(() => {
  ...
  return (
    <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden bg-ink px-6 py-16 text-white">
      <Image
        ...
        alt="Quattro Plaza Center, Cancún"
      ...
      <div className="relative z-10 w-full max-w-lg text-center">
        ...
        <p className="mx-auto mt-4 max-w-md text-[15px] font-light leading-relaxed text-white/70">
          Un asesor especializado en Quattro Plaza Center te contactará muy pronto con
          disponibilidad real, precios y planes de pago de Gardens y Long Island. Mientras tanto,
          adelántate por WhatsApp:
        </p>

        <a
          href={waLink('Hola, acabo de dejar mis datos en la campaña de Quattro Plaza Center (Gardens y Long Island). Quiero más información.')}
        ...
        <div className="mx-auto mt-12 grid max-w-md gap-3 text-left sm:grid-cols-2">
          {[
            ...
            { icon: CalendarCheck, title: 'Visita privada', sub: 'Presencial o por videollamada' },
