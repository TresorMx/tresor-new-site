...
export default function VellmariGracias() {
  ...
  // OJO: el send_to es el MISMO label que usa la landing de Valmira. Si se
  // quiere separar el reporte de Vellmari en Google Ads, hay que crear una
    ...
    <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden bg-ink px-6 py-16 text-white">
      ...
      <div className="relative z-10 w-full max-w-lg text-center">
        ...
        <p className="mx-auto mt-4 max-w-md text-[15px] font-light leading-relaxed text-white/70">
          Un asesor especializado en Vellmari te contactará muy pronto con disponibilidad real por torre,
          precios y planes de pago. Mientras tanto, adelántate por WhatsApp:
        </p>

        <a
          href={waLink('Hola, acabo de dejar mis datos en la página de Vellmari, Puerto Cancún. Quiero agendar una visita.')}
