...
export default function LoretaGracias() {
  ...
  // (Valmira, Vellmari, Portafolio Cancún). Para reportar esta campaña por
  ...
  useEffect(() => {
    ...
    if (typeof (window as any).fbq === 'function') {
      (window as any).fbq('track', 'Lead', { content_name: 'Loreta Landing', content_category: 'ads' });
    }
  }, []);
  ...
  return (
    <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden bg-ink px-6 py-16 text-white">
      <Image
        src="/desarrollos/loreta/7.-Piscina-Infinity_.jpg"
        alt="Loreta Wow Condos — Lausana Residencial"
      ...
      <div className="relative z-10 w-full max-w-lg text-center">
        ...
        <p className="mx-auto mt-4 max-w-md text-[15px] font-light leading-relaxed text-white/70">
          Un asesor especializado en Loreta te contactará muy pronto con disponibilidad real,
          precios y planes de pago. Mientras tanto, adelántate por WhatsApp:
        </p>

        <a
          href={waLink('Hola, acabo de dejar mis datos en la página de Loreta, Lausana Residencial. Quiero más información.')}
