...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.error('[broker/reset-password] falló para', email, e);
    return NextResponse.json({ error: 'No pudimos actualizar tu contraseña. Intenta de nuevo en unos minutos.' }, { status: 500 });
  }
}
