...
export const developments: Development[] = [
  ...
  },
  {
    ...
    floorPlans: [
      // Torre Sur (6) — recámaras contadas de los renders (planos sin rótulo).
      { slug: 'sur-c', tower: 'sur', area: '169 m²', label: { es: 'Tipo C', en: 'Type C' }, image: '/desarrollos/Vellmari/floorplans/Torre_Sur_C_169m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '2' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'sur-a', tower: 'sur', area: '248 m²', label: { es: 'Tipo A', en: 'Type A' }, image: '/desarrollos/Vellmari/floorplans/Torre_Sur_A_248m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '3' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'sur-d', tower: 'sur', area: '303 m²', label: { es: 'Tipo D', en: 'Type D' }, image: '/desarrollos/Vellmari/floorplans/Torre_Sur_D_303m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '3' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'sur-f', tower: 'sur', area: '311 m²', label: { es: 'Tipo F', en: 'Type F' }, image: '/desarrollos/Vellmari/floorplans/Torre_Sur_F_311m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '3' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'sur-3a', tower: 'sur', area: '366 m²', label: { es: 'Tipo 3A', en: 'Type 3A' }, image: '/desarrollos/Vellmari/floorplans/Torre_Sur_3A_366m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '3' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'sur-ph3', tower: 'sur', area: '714 m²', label: { es: 'PH3', en: 'PH3' }, image: '/desarrollos/Vellmari/floorplans/Torre_Sur_PH3_714m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '4' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      // Torre Norte (11)
      { slug: 'norte-c', tower: 'norte', area: '172 m²', label: { es: 'Tipo C', en: 'Type C' }, image: '/desarrollos/Vellmari/floorplans/Torre_Norte_C_172m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '2' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'norte-g', tower: 'norte', area: '172 m²', label: { es: 'Tipo G', en: 'Type G' }, image: '/desarrollos/Vellmari/floorplans/Torre_Norte_G_172m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '2' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'norte-a', tower: 'norte', area: '250 m²', label: { es: 'Tipo A', en: 'Type A' }, image: '/desarrollos/Vellmari/floorplans/Torre_Norte_A_250m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '3' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'norte-h', tower: 'norte', area: '250 m²', label: { es: 'Tipo H', en: 'Type H' }, image: '/desarrollos/Vellmari/floorplans/Torre_Norte_H_250m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '3' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'norte-e', tower: 'norte', area: '324 m²', label: { es: 'Tipo E', en: 'Type E' }, image: '/desarrollos/Vellmari/floorplans/Torre_Norte_E_324m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '3' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'norte-f', tower: 'norte', area: '324 m²', label: { es: 'Tipo F', en: 'Type F' }, image: '/desarrollos/Vellmari/floorplans/Torre_Norte_F_324m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '3' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'norte-1a-garden', tower: 'norte', area: '338 m²', label: { es: 'Garden 1A', en: 'Garden 1A' }, image: '/desarrollos/Vellmari/floorplans/Torre_Norte_1A_Garden_338m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '3' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'norte-3h', tower: 'norte', area: '366 m²', label: { es: 'Tipo 3H', en: 'Type 3H' }, image: '/desarrollos/Vellmari/floorplans/Torre_Norte_3H_366m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '3' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'norte-11f', tower: 'norte', area: '400 m²', label: { es: 'Tipo 11F', en: 'Type 11F' }, image: '/desarrollos/Vellmari/floorplans/Torre_Norte_11F_400m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '3' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'norte-ph1', tower: 'norte', area: '445 m²', label: { es: 'PH1', en: 'PH1' }, image: '/desarrollos/Vellmari/floorplans/Torre_Norte_PH1_445m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '3' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
      { slug: 'norte-ph2', tower: 'norte', area: '535 m²', label: { es: 'PH2', en: 'PH2' }, image: '/desarrollos/Vellmari/floorplans/Torre_Norte_PH2_535m.jpg', specs: [{ key: 'recamaras', label: { es: 'Recámaras', en: 'Bedrooms' }, value: '4' }, { key: 'servicio', label: { es: 'Cuarto de servicio', en: 'Service room' }, value: 'Sí' }] },
    ],
  },
  {
    slug: 'la-selva-urban',
