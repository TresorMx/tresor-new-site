// Lista de artículos del blog — fuente única. La leen el índice /blog y
// /en/blog (blog/page.tsx) y el /llms.txt. Antes vivía dentro de
// blog/page.tsx, y por eso un post nuevo no aparecía en el índice si no se
// agregaba a mano ahí (pasó con el post de ROI).
//
...
export const articlesEs = [
  ...
  },
  {
    ...
    description:
      'Si buscas rendimientos mayores que en tu ciudad, Cancún ofrece locales comerciales desde $1,968,600 MXN + IVA con plusvalía de 10–15% anual y proceso 100% remoto.',
