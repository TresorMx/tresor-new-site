...
const TARGET_SLUGS = ['olivia-wow-condos', 'koa-onix', 'zienna-onix', 'blume-urban', 'esther-wow-condos', 'ximena-wow-condos', 'loreta-wow-condos', 'valmira-urban', 'villalta-onix', 'xaviera-wow-condos', 'vellmari-puerto-cancun', 'lindavista-locales', 'lindavista-bodegas', 'cuore', 'la-selva-playa-del-carmen'];
